...
const acteursRoutes = require("./routes/acteursRoutes");
const acteureventRoutes = require("./routes/acteureventRoutes");
...
app.use(groupRoutes);
app.use(acteursRoutes);
app.use(acteureventRoutes);
